...
class _ConfirmationFormState extends State<ConfirmationForm> {
  ...
  @override
  Widget build(BuildContext confirmationContext) {
    var auth = Provider.of<AuthProvider>(confirmationContext);
    Future<dynamic> handleExitApp() async{
      final result= await showDialog(
          context: confirmationContext,
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text("Do you want to go back to phone page?"),
              actions: <Widget>[
                FlatButton(
                    onPressed: (){
                                          ...
                                          Container(
                                              ...
                                              child: ElevatedButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    confirmationContext.loaderOverlay.show();
                                                    if (_formKey.currentState.validate()) {
                                                      ...
                                                      if (successInfo['success']) {
                                                        ...
                                                        if(userExists){
                                                          confirmationContext.loaderOverlay.hide();
