...
class ImporterCart extends StatefulWidget {

  @override
  _ImporterCartState createState() => _ImporterCartState();
}

class _ImporterCartState extends State<ImporterCart> {
            ...
            child: Stack(children: <Widget>[
              Container(
                  child: FutureBuilder<List<Cart>>(
                      future: cartProvider.getMyImporterCartDrugs(""),//TODO add the user id after login
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: ElevatedButton(
                  onPressed: (){
                    Provider.of<CartProvider>(context, listen: false).deleteDrugFromImporterCart(category);
