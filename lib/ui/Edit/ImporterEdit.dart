...
class ImporterEdit extends StatefulWidget {
  final ImporterPharmacy importer;
  const ImporterEdit({Key key, this.importer,}) : super(key: key);

  @override
  _ImporterEditState createState() => _ImporterEditState();
}

class _ImporterEditState extends State<ImporterEdit> {
      ...
      switch (item) {
        case 0:
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => MultiImagePharmacy(importerPharmacy: widget.importer,)//(hospital: widget.hospital,)
              ));
          break;
        default:
          break;
        ...
        home: FutureBuilder<Importers>(
            ...
            builder: (context , snapshot) {
              ...
              if (snapshot.data == null) {
                ...
                return Scaffold(
                  appBar: AppBar(
                    title: Text(widget.importer.title),
                    actions: [
                      IconButton(
                        ...
                        onPressed: (){
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ImporterDetail(importer: widget.importer,
                                  )));
                        },
                        icon: Icon(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext ctxt, int index) {
                                        return _buildHopitalServicesListItem(
                                            snapshot.data.images[index], ctxt);
                                      },
                                          ...
                                          Row(
                                            children: [
                                              Container(
                                                ...
                                                child: IconButton(
                                                  onPressed: (){
                                                    _messageControler.text = widget.importer.officeHours;
                                                    _firstTime= widget.importer.officeHours.split("-").first;
                                                    _secondTime=widget.importer.officeHours.split("-").last;
                                          ...
                                          Row(
                                            children: [
                                              Container(
                                                ...
                                                child: IconButton(
                                                  onPressed: (){
                                                    _messageControler.text = widget.importer.info;
                                                    editMessageInfoLocName(context, "Additional Information", widget.importer.info,2);
                                                  },
                                                  icon: Icon(
                                                      Icons.edit_outlined
                                                  ),
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                // builder: (context) => ListInServices()
                  builder: (context) => DetailCategoryEdit(pharmacyServices:pharmacyServices, importerPharmacy: widget.importer,)
              ));
        },
        child: Card(
            elevation: 0,
  ...
  //       widget.importer.services.add(element);
  //     }
  //   });
  //
  // }
  ...
  //                               context,
  //                               MaterialPageRoute(
  //                                   builder: (context) => ImporterEdit(importer : widget.importer)));
  //                         }
  //                       }),
  //                 ],
  //               );
                                        ...
                                        child: Center(
                                            child: Container(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onSaved: (String value){
                                                    setState(() {
                                                      widget.importer.detail=value;
                                                      FirebaseFirestore.instance.collection('importers')
                                                          .doc(pharmacyId)
                                                          .update({'description': widget.importer.detail})
                    ...
                    new ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (_formKey.currentState.validate()) {
                          ...
                          setState((){
                            widget.importer.phone=fullPhone;
                            FirebaseFirestore.instance.collection('importers')
                                .doc(pharmacyId)
                ...
                return AlertDialog(
                  ...
                  actions: <Widget>[
                    new ElevatedButton(
                        ...
                        onPressed: () {
                          setState(() {
                            widget.importer.officeHours=("$_firstTime - $_secondTime");
                            FirebaseFirestore.instance.collection('importers')
                                .doc(pharmacyId)
                                .update({'officehours': "$_firstTime - $_secondTime"})
                                .then((value) => print("OfficeHour Updated"))
                                .catchError((error) => print("Failed to update user: $error"));
                            Navigator.of(context).pop();
                            Navigator.push(
                                context,
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onSaved: (String value){
                                                    setState(() {
                                                      switch(code){
                                                        case 1: {
                                                          widget.importer.name=value;
                                                          print(widget.importer.name);
                                                          print(value);

                                                        }
                                                        break;
                                                        case 2: {
                                                          widget.importer.info=value;
                                                          print(widget.importer.info);
                                                          print(value);
                                                        }
                                                        break;
                                                        case 3: {
                                                          widget.importer.location=value;
                                                          print(widget.importer.location);
                                                          print(value);
                                                        }
                                                        break;
