...
class _AddServicesState extends State<AddServices> {
  ...
  Future<void> appendToArray(String id, HospServicesTypes element) async {
    ...
    FirebaseFirestore.instance.collection('diagnostics').doc(id).update({
      'services': FieldValue.arrayUnion([data]),
    });
  }
  Future<void> clearHospital(String id) async {
    FirebaseFirestore.instance.collection('diagnostics').doc(id).update({'services': FieldValue.delete()}).whenComplete((){
      print('Field Deleted');
    });
