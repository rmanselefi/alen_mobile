...
class EmergencyMSDetail extends StatefulWidget {
  final String emergencyMSId;

  const EmergencyMSDetail ({ Key key, this.emergencyMSId }): super(key: key);


  @override
  _EmergencyMSDetailState createState() => _EmergencyMSDetailState();
}

class _EmergencyMSDetailState extends State<EmergencyMSDetail> {
  ...
  Widget build(BuildContext firstParentContext) {
    ...
    var emergencyMSProvider = Provider.of<EmergencyMSProvider>(firstParentContext, listen: false);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            return FutureBuilder<EmergencyMS>(
                future: emergencyMSProvider.fetchEmergencyMS(widget.emergencyMSId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.none &&
                      snapshot.hasData == null) {
                    return Scaffold(
