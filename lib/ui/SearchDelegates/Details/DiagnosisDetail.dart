...
class DiagnosisDetail extends StatefulWidget {
  ...
  const DiagnosisDetail ({ Key key, this.diagnosisId }): super(key: key);
...
class _DiagnosisDetailState extends State<DiagnosisDetail> {
  ...
  Widget build(BuildContext firstParentContext) {
    ...
    var diagnosticsProvider = Provider.of<DiagnosticProvider>(firstParentContext, listen: false);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            return FutureBuilder<Diagnostics>(
                future: diagnosticsProvider.fetchDiagnostics(widget.diagnosisId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.none &&
                      snapshot.hasData == null) {
                    return Scaffold(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<HLDServices>>(
                                        future: diagnosticsProvider
                                            .getDiagnosisServicesByHospitalId(widget.diagnosisId),
