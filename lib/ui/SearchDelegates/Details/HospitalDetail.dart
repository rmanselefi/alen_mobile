...
class HospitalDetail extends StatefulWidget {
  ...
  const HospitalDetail ({ Key key, this.hospitalId }): super(key: key);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            return FutureBuilder<Hospitals>(
                future: hosProvider.fetchHospital(widget.hospitalId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.none &&
                      snapshot.hasData == null) {
                    return Scaffold(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<HLDServices>>(
                                        future: hosProvider
                                            .getHospServicesByHospitalId(widget.hospitalId),
