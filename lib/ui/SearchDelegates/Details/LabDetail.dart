...
class LabDetail extends StatefulWidget {
  ...
  const LabDetail ({ Key key, this.labId }): super(key: key);
...
class _LabDetailState extends State<LabDetail> {
  ...
  Widget build(BuildContext firstParentContext) {
    ...
    var labProvider = Provider.of<LaboratoryProvider>(firstParentContext, listen: false);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            return FutureBuilder<Laboratories>(
                future: labProvider.fetchLaboratory(widget.labId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.none &&
                      snapshot.hasData == null) {
                    return Scaffold(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FutureBuilder<List<HLDServices>>(
                                        future: labProvider
                                            .getLabServicesByHospitalId(widget.labId),
