...
class HomeCareDetail extends StatefulWidget {
  final String homeCareId;

  const HomeCareDetail ({ Key key, this.homeCareId }): super(key: key);


  @override
  _HomeCareDetailState createState() => _HomeCareDetailState();
}

class _HomeCareDetailState extends State<HomeCareDetail> {
  ...
  Widget build(BuildContext firstParentContext) {
    ...
    var homeCareProvider = Provider.of<HomeCareProvider>(firstParentContext, listen: false);
    ...
    return FutureBuilder<dynamic>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data == null) {
            ...
            return FutureBuilder<HomeCare>(
                future: homeCareProvider.fetchHomeCare(widget.homeCareId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.none &&
                      snapshot.hasData == null) {
                    return Scaffold(
