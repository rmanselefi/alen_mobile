...
class _CompaniesPageState extends State<CompaniesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if(SearchProvider.companies2.isEmpty ){
      SearchInitializer();
    }
                                ...
                                children: <Widget>[
                                  GestureDetector(
                                      onTap: () {
                                        ...
                                        hld += SearchProvider.companies2;
                                        showSearch<TrendingSearchable>(
                                            context: context,
                                            delegate: TrendingSearch2(trendings: hld, searchFor: "Search Companies"));
                                      },
                                      child: Container(
