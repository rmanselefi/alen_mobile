...
class _HomeCaresPageState extends State<HomeCaresPage> {
  ...
  Future<void> SearchInitializer() async {
    ...
    await Provider.of<SearchProvider>(context, listen: false)
        .fetchAllHomeCares2(location);

  }
  @override
  Widget build(BuildContext context) {
    if(SearchProvider.homecares2.isEmpty ){
      SearchInitializer();
    }
                                ...
                                children: <Widget>[
                                  GestureDetector(
                                      onTap: () {
                                        ...
                                        hld += SearchProvider.homecares2;
                                        showSearch<TrendingSearchable>(
                                            context: context,
                                            delegate: TrendingSearch2(trendings: hld, searchFor: "Search Home Cares"));
                                        // showSearch<HomeCare>(
                                        //     context: context,
